...
class Intent(Enum):
    ...
    NETWORK_VIZ = "network_viz"       # 网络可视化 (Traceroute/Ping)
    HELP = "help"                     # 帮助
    UNKNOWN = "unknown"               # 未知
...
class IntentClassifier:
    ...
    def __init__(self, llm_client=None):
        ...
        self.intent_keywords = {
            ...
            Intent.NETWORK_VIZ: [
                "traceroute", "trace", "路径", "路由",
                "ping", "rtt", "延迟分析",
                "末端", "as路径", "asgeo路径",
                "网络路径", "路径分析", "节点分析",
                "prefix24", "数据中心分析",
                "时序分析", "网络可视化",
                "network visualization", "path analysis",
            ],
            Intent.HELP: [
                "帮助", "怎么用", "能做什么", "功能",
    ...
    def _extract_entities(self, query: str) -> Dict[str, Any]:
        ...
        region_patterns = [
            ...
            r"(UKRAINE|Ukraine|乌克兰)",
            r"(RUSSIA|Russia|俄罗斯)",
            r"(JAPAN|Japan|日本)",
            r"(GERMANY|Germany|德国)",
            r"(FRANCE|France|法国)",
            r"(UK|United Kingdom|英国)",
            r"(BRAZIL|Brazil|巴西)",
            r"(INDIA|India|印度)",
            r"(AUSTRALIA|Australia|澳大利亚)",
        ]
        for pattern in region_patterns:
            match = re.search(pattern, query, re.IGNORECASE)
            if match:
                entities["region"] = match.group(0).upper().replace("-", "_")
                break
    ...
    def _get_suggested_agents(
        ...
        agent_mapping = {
            ...
            Intent.NETWORK_VIZ: ["network_viz_agent"],
            Intent.HELP: [],
