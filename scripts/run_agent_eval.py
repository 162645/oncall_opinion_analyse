...
def main() -> None:
    ...
    if args.output:
        ...
        md = ["# Agent Replay Comparison", "", "| Metric | Free ReAct | Evidence Harness |", "|---|---:|---:|",
              ...
              f"| Task success rate | {summary['free_react']['task_success_rate']:.2%} | {summary['harness']['task_success_rate']:.2%} |",
              f"| Verdict match (diagnostic) | {summary['free_react']['correct_abstain_rate']:.2%} | {summary['harness']['correct_abstain_rate']:.2%} |",
